  ...
  <div class="informational-box">
    ...
    <div class="content">
      ...
      <div class="image-gallery">
        <div
            v-if="tabs.find(tab => tab.id === selectedTab)?.largeImageURL"
            class="main-image"
            :style="{ backgroundImage: 'url(' + tabs.find(tab => tab.id === selectedTab).largeImageURL + ')' }">
        </div>
        <div
            v-if="tabs.find(tab => tab.id === selectedTab)?.smallImageURL1"
            class="sub-image"
            :style="{ backgroundImage: 'url(' + tabs.find(tab => tab.id === selectedTab).smallImageURL1 + ')' }">
        </div>
        <div
            v-if="tabs.find(tab => tab.id === selectedTab)?.smallImageURL2"
            class="sub-image"
